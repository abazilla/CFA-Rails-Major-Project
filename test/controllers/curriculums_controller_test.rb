...
class CurriculumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curriculum" do
    assert_difference('Curriculum.count') do
      post curriculums_url, params: { curriculum: { content: @curriculum.content, title: @curriculum.title, user_id: @curriculum.user_id } }
    end
  ...
  test "should update curriculum" do
    patch curriculum_url(@curriculum), params: { curriculum: { content: @curriculum.content, title: @curriculum.title, user_id: @curriculum.user_id } }
